#!/bin/bash
#SBATCH --job-name=amix_subspace
#SBATCH --cpus-per-task=8
#SBATCH --mem=256G
#SBATCH --time=02:00:00
#SBATCH --output=logs/accelmix_subspace_%j.out
#SBATCH --error=logs/accelmix_subspace_%j.err
...
python -u experiments/threads/acceleration/04_operators/accel_subspace.py \
    ...
    --layers 6,12,18,23 \
    --output_dir $BASE/outputs/analysis/moving_ball_accel2d_mixed/subspace \
    --save_k 16
echo "[amix_subspace] exit=$?"
