#!/bin/bash
#SBATCH --job-name=angvel_diag2
#SBATCH --gres=gpu:b200:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=60G
#SBATCH --time=00:30:00
#SBATCH --output=logs/angvel_diag2_%j.out
#SBATCH --error=logs/angvel_diag2_%j.err
...
python -u experiments/threads/angular-velocity/07_eval/diag_angvel_decode.py \
  ...
  --checkpoint $BASE/outputs/runs/moving_ball_scene_angvel2d_decoder_orient/checkpoints/last.pt \
  --num_scenes 16 --device cuda
echo "[angvel_diag2] exit=$?"
